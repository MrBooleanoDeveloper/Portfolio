...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Diego Salas — Software Engineer" },
      {
        name: "description",
        content:
          "Portfolio de Diego Salas, ingeniero de software full-stack especializado en interfaces performantes, sistemas escalables y experiencias de producto pulidas.",
      },
      { name: "author", content: "Diego Salas" },
      { property: "og:title", content: "Diego Salas — Software Engineer" },
      {
        property: "og:description",
        content:
          "Full-stack engineer construyendo producto con React, TypeScript y sistemas distribuidos.",
      },
